...
public class DashboardController implements Initializable, Server.Listener {
    ...
    @FXML private Circle serverOnlineShape;
    @FXML private Circle serverOfflineShape;
    @FXML private Label lblServerStatus;
    @FXML private Canvas activePlayersCanvas;
    @FXML private Label lblActivePlayersCount;
    @FXML private Canvas onlinePlayersCanvas;
    @FXML private Label lblOnlinePlayersCount;
    @FXML private Canvas offlinePlayersCanvas;
    @FXML private Label lblOfflinePlayersCount;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ClientService.getService().addPlayerUpdateListener((username, isAdd, isRemove, isAvailable, isInGame) -> {
            updateGraphs();
    ...
    private void updateGraphs() {
        ...
        int onlineCount = ClientService.getService().getUsernameCount();
